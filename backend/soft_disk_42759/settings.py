"""
Django settings for soft_disk_42759 project.
...
ROOT_URLCONF = 'soft_disk_42759.urls'
...
WSGI_APPLICATION = 'soft_disk_42759.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "soft_disk_42759 API",
    "DESCRIPTION": "API documentation for soft_disk_42759 App",
    "VERSION": "v1",
}
